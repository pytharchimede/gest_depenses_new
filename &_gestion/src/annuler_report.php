...
$num_fiche=addslashes($_GET['num_fiche_valide']);
$date_today=gmdate('Y-m-d');

//Mettre à jour si déjà existant
$req=$con->prepare('UPDATE fiche SET date_decaissement_minimum=:B WHERE num_fiche=:A');
$req->execute(array('A'=>$num_fiche, 'B'=>$date_today));
...
$lib_trace="Modification de la date de décaissement de la fiche  N° <b>".$num_fiche."</b> soumise par <b>".$beneficiaire_fiche."</b> pour <b>".$designation_fiche."</b> à <b>'.$date_today.'</b> <br> ";
