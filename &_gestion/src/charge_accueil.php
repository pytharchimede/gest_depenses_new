...
if ($count > 0) {
    ...
    foreach ($records as $row) {
        ...
        if ($_SESSION['is_valid'] == 1) {
            $HTML .= '
                    <a href="src/valider_fiche.php?num_fiche_valide=' . $row['num_fiche'] . '" class="btn btn-success"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Profile"><i class="uil uil-check"></i></button></a>
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reporterModal' . $row['num_fiche'] . '">
                        <i class="fas fa-flag"></i> <!-- Icône de rapport -->
                        Reporter
                    </a>
                    <a href="detail_refus.php?num_fiche_refuse=' . $row['num_fiche'] . '" class="btn btn-danger"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Projects"><i class="uil uil-trash"></i></button></a>
                ';
        }
        ...
        $HTML .= '
        <div class="modal fade" id="reporterModal' . $row['num_fiche'] . '" tabindex="-1" aria-labelledby="reporterModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="reporterModalLabel">Reporter la fiche N°' . $row['num_fiche'] . '</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="src/reporter_fiche.php" method="POST">
                            <div class="mb-3">
                                <label for="new_date" class="form-label">Veuillez sélectionner une nouvelle date de report</label>
    ...
    $donnee = mb_convert_encoding($titre, 'ISO-8859-1', 'UTF-8');
