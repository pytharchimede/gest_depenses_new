...
$montant_fiche=$_GET['montant_fiche'];

//Mettre à jour si déjà existant
$req=$con->prepare('UPDATE fiche SET montant_fiche=:A WHERE num_fiche=:B');
$req->execute(array('A'=>$montant_fiche, 'B'=>$num_fiche));
...
$lib_trace="Modification de la fiche  N° <b>".$num_fiche."</b> soumise par <b>".$beneficiaire_fiche."</b> pour <b>".$designation_fiche."</b> <br> ";
