...
<head>
    ...
    <style>
        body {
            background-image: url('background-image.jpg'); /* Remplacez 'background-image.jpg' par votre image de fond */
        ...
        input[type="text"] {
            width: 60px; /* Largeur de la case de saisie */
            height: 60px; /* Hauteur de la case de saisie */
            text-align: center; /* Alignement du texte au centre */
            font-size: 2em; /* Taille de la police */
            margin: 10px; /* Marge autour de chaque case */
        }
    </style>
</head>
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="otp-form mt-5">
                <form action="verification_otp.php?id_fiche=<?php echo $num_fiche; ?>" method="POST">
