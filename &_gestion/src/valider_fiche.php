...
$req=$con->prepare('UPDATE fiche SET etat_fiche=1, sauvegarder=0, secur_valid="'.$_SESSION['secur_hop'].'" WHERE num_fiche=:A');
...
$lib_trace="Validation de la fiche  N° <b>".$num_fiche."</b> soumise par <b>".$beneficiaire_fiche."</b> pour <b>".$designation_fiche."</b> <br> ";
