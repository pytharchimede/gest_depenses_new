    ...
    foreach ($records as $row) {
        ...
        if ($_SESSION['is_valid'] == 1) {
            ...
            $HTML .= '
                    ...
                    <a href="src/sauvegarder_fiche.php?num_fiche_sauvegarder=' . $row['num_fiche'] . '" class="btn btn-primary"><button type="button" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Message"><i class="uil uil-save"></i></button></a>
