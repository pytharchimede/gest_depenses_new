...
class FicheManager
{
    ...
    {
        $this->con = $db->getConnection(); // Utilise la connexion de la classe Database
    ...
    public function createFiche($data)
    {
        ...
        $date_decaissement_minimum = $data['date_decaissement_minimum'];
        $code_parental = $data['code_parental'];
        ...
        $req = $this->con->prepare('
            INSERT INTO fiche (
                ...
                serv_bureau_fidest_id, serv_rh_id, serv_log_id, date_decaissement_minimum, code_parental,
        ...
        $req->execute([
            ...
            'M' => $serv_rh_id,
            'N' => $serv_log_id,
            'O' => $date_decaissement_minimum,
            'P' => $code_parental,
            'Q' => $etat_fiche,
            'R' => $secur_valid,
            'S' => $photo_beneficiaire,
            'T' => $secur_decaisse,
            'U' => $cni_beneficiaire,
            'V' => $secur_approuve,
            'W' => $date_approuve,
            'X' => $approuve,
            'Y' => $signature_beneficiaire,
            'Z' => $conforme,
            'AA' => $secur_conforme,
            'BB' => $date_conforme
        ]);
