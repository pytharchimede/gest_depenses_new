...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-8">
        ...
        <div class="flex justify-center mt-4 mb-8">
            <a target="_blank" href="https://fidest.ci/logi/gestion_cron/exportation/pdf/gen_point_partiel.php"
                class="inline-flex items-center text-gray-700 hover:text-gray-900 text-lg font-medium transition duration-200 ease-in-out p-3 rounded border border-gray-300 hover:border-gray-500">
                <!-- Icône PDF -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5 mr-2">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9l6 6 6-6"></path>
                </svg>
                Exporter la liste des décaissements du jour en PDF
            </a>
        </div>

        <?php include 'form/form_search_fiche_decaisse.php'; ?>

        <div id="totalMontant" class="bg-white p-4 rounded-lg shadow mb-6 sticky top-0 z-10">
        ...
        <button id="exportBtn" onclick="exportToPDF()" disabled class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm">
            Exporter PDF
        </button>
    ...
    <script>
        ...
        function updateResults(fiches) {
            ...
            currentFiches = fiches;
            console.log("Fiches actuelles :", currentFiches);
        ...
        function getCurrentFiches() {
            return currentFiches;
        }
    </script>
