...
?>
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('titre_ent_1.php'); ?> | Point financier</title>
...
-->
                                ...
                                <div class="card-body" style="position: relative;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                            <label class="col-lg-4 control-label"><b>Nom et Prénoms </b></label>
                                            ...
                                            <select <?php if ($_SESSION['resp_logistique'] == 1 || $_SESSION['resp_technique'] == 1 || $_SESSION['resp_bureau'] == 1 || $_SESSION['resp_rh'] == 1) {
                                                ...
                                                ?>
                                                    <option value="<?php echo '' . $ro['id_affectation'] . ''; ?>" <?php if ($_SESSION['resp_rh'] == 1 && $ro['id_affectation'] == 28) {
                                                                                                                ...
                                                                                                                if (($_SESSION['resp_technique'] == 1 || $_SESSION['verif_conforme']) && $ro['id_affectation'] == 1) {
                                                                                                                    echo ' selected';
                                                                                                                }
                                        ...
                                        <div class="col-lg-4 col-xs-12" style="margin-top:10px;">
                                            <label class="col-lg-4 control-label"><b>Etat Approbation</b></label>
                                            <select class="form-control" data-trigger id="recher_approbation" name="recher_approbation">
                                                <option value="0">Etat Approbation</option>
                                                <option value="1">Approuvée</option>
                                                <option value="2">Désapprouvée</option>
                                            </select>
                                        </div>

                                        <div class="col-lg-3 col-xs-12" style="margin-top:10px;">
                                            <label class="col-lg-4 control-label"><b>Motif demande</b></label>
                                            <input type="text" class="form-control" name="recher_motif" id="recher_motif" placeholder="Motif de la demande">
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-xs-12" style="margin-top:10px;">
                                            <label class="col-lg-4 control-label"><b>Catégorie Logistique</b></label>
                                            <select class="form-control" data-trigger id="recher_serv_log" name="recher_serv_log">
                                                <option value="">Choisir catégorie</option>
                                                <?php
                                                //include('../../../connex.php');
                                                $red = $con->prepare("SELECT * FROM serv_log ORDER BY lib_serv_log ASC");
                                                $red->execute();
                                                while ($ro = $red->fetch()) {
                                                ?>
                                                    <option value="<?php echo '' . $ro['id_serv_log'] . ''; ?>"><?php echo '' . stripslashes($ro['lib_serv_log']) . ''; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="col-lg-3 col-xs-12" style="margin-top:10px;">
                                            <label class="col-lg-4 control-label"><b>Catégorie RH</b></label>
                                            <select class="form-control" data-trigger id="recher_serv_rh" name="recher_serv_rh">
                                                <option value="">Choisir catégorie</option>
                                                <?php
                                                //include('../../../connex.php');
                                                $red = $con->prepare("SELECT * FROM serv_rh ORDER BY lib_serv_rh ASC");
                                                $red->execute();
                                                while ($ro = $red->fetch()) {
                                                ?>
                                                    <option value="<?php echo '' . $ro['id_serv_rh'] . ''; ?>"><?php echo '' . stripslashes($ro['lib_serv_rh']) . ''; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="col-lg-2 col-xs-12" style="margin-top:10px;">
                                            <label class="col-lg-4 control-label"><b>Etat</b></label>
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <script type="text/javascript" src="js/function_point.js"></script>
