!(function (e, t) {
    ...
    function it(e, t, n, o) {
        H() ? rt(e, o) : (He(n).then(() => rt(e, o)), Ie.keydownTarget.removeEventListener("keydown", Ie.keydownHandler, { capture: Ie.keydownListenerCapture }), (Ie.keydownHandlerAdded = !1)),
    ...
    e = Object.freeze({
        ...
        _main: function (e, t = {}) {
            ...
            var s,
                ...
                c,
                t = ((e) => {
                    const t = { popup: v(), container: b(), actions: L(), confirmButton: E(), denyButton: P(), cancelButton: T(), loader: S(), closeButton: M(), validationMessage: x(), progressSteps: B() };
            ...
            return (
                ...
                new Promise((e) => {
                    ...
                    ot.swalPromiseResolve.set(s, e),
                        ...
                        (e = s),
                        "select" === (a = c).input || "radio" === a.input ? Ot(e, a) : ["text", "email", "number", "tel", "textarea"].includes(a.input) && (u(a.inputValue) || p(a.inputValue)) && (Me(E()), jt(e, a)),
                        At(c),
                        en(Ie, c, t),
                        tn(r, c),
                        setTimeout(() => {
