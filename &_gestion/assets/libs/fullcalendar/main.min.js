...
var FullCalendar = (function (e) {
    ...
    var Ze = ["dim", "lun", "mar", "mer", "jeu", "ven", "sam"];
    function Xe(e, t) {
        var n = lt(e);
        return (n[2] += 7 * t), ut(n);
    }
    ...
    function hn(e, t, n, r) {
        for (var o = { defs: {}, instances: {} }, i = Pn(n), a = 0, s = e; a < s.length; a++) {
    ...
    function xn(e, t, n, r, o) {
        ...
        if (u) return ((c = In(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = { typeId: u.typeId, typeData: u.typeData, duration: u.duration }), { def: c, instance: null };
        var c,
            d = (function (e, t, n, r) {
                var o,
                    i,
        ...
        return d ? { def: (c = In(a, s, t ? t.sourceId : "", d.allDay, d.hasEnd, n)), instance: pt(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo) } : null;
    }
    function Mn(e, t, n) {
    ...
    var Pr = (function () {
        ...
        Nr = {
            ...
            week: { dow: 0, doy: 4 },
            direction: "ltr",
            buttonText: { prev: "prec", next: "suiv", prevYear: "année prec", nextYear: "année suiv", year: "année", today: "aujourd'hui", month: "mois", week: "semaine", day: "jour", list: "liste" },
            weekText: "W",
            allDayText: "tous les jours",
            moreLinkText: "plus",
            noEventsText: "Aucun enregistrement",
        };
    function Hr(e) {
        for (var t = e.length > 0 ? e[0].code : "en", n = Ir.concat(e), r = { en: Nr }, o = 0, i = n; o < i.length; o++) {
            var a = i[o];
            r[a.code] = a;
        }
    ...
    function Ur(e) {
        ...
        return new Pr(r(r({ timeZone: on.timeZone, calendarSystem: "gregory" }, e), { locale: t }));
    }
    var Lr,
        ...
        return (
            ...
            (e.prototype.adjustActiveRange = function (e) {
                var t = this.props,
                    ...
                    a = e.start,
                    s = e.end;
                return r && (It(o) < 0 && ((a = rt(a)), (a = n.add(a, o))), It(i) > 1 && ((s = Ke((s = rt(s)), -1)), (s = n.add(s, i)))), { start: a, end: s };
            }),
        ...
        return (
            ...
            (e.prototype._handleAction = function (e) {
                ...
                this.data && this.data.dateProfileGenerator !== u.dateProfileGenerator && (p = u.dateProfileGenerator.build(d)),
                    ...
                    ("PREV" !== e.type && "NEXT" !== e.type && Bn(p.currentRange, d)) || (d = p.currentRange.start);
                for (
    ...
    function _i(e, t, n, r, o, i, a, s) {
        ...
        return new Pr({ calendarSystem: "gregory", timeZone: e, namedTimeZoneImpl: i.namedTimeZonedImpl, locale: l, weekNumberCalculation: n, firstDay: r, weekText: o, cmdFormatter: i.cmdFormatter, defaultSeparator: s });
    }
    function Ti(e, t) {
            ...
            return (
                ...
                (e.prototype.splitEntry = function (e, t, n) {
                    ...
                    return (
                        ...
                        r ? (n.push.apply(n, o([{ index: e.index, thickness: e.thickness, span: Bi(s, a) }], i)), r) : (n.push(e), 0)
                    );
                }),
                ...
                (e.prototype.findInsertion = function (e) {
                    for (var t = this, n = t.levelCoords, r = t.entriesByLevel, o = t.stackCnts, i = t.strictOrder, a = n.length, s = 0, l = 0, u = 0, c = 0, d = -1, p = null, f = 0; f < a; f += 1) {
                        ...
                        for (c = u = m[0] + m[1]; (g = v[c]) && g.span.start < e.span.end; ) (i || (s < h + g.thickness && s + e.thickness > h)) && ((s = h + g.thickness), (d = f), (p = g)), (c += 1);
                        h < s && (l = f + 1);
                    }
                    return { level: l, levelCoord: s, lateralStart: u, lateralEnd: c, touchingLevel: d, touchingEntry: p, stackCnt: p ? o[Vi(p)] + 1 : 0 };
                }),
    ...
    function Fi(e) {
        for (var t = [], n = 0, r = e; n < r.length; n++) {
            for (var o = r[n], i = [], a = { span: o.span, entries: [o] }, s = 0, l = t; s < l.length; s++) {
                var u = l[s];
                Bi(u.span, a.span) ? (a = { entries: u.entries.concat(a.entries), span: zi(u.span, a.span) }) : i.push(u);
            }
            i.push(a), (t = i);
        }
        return t;
        ...
        ta = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderSection = function (e, t) {
                    var n = this.props;
                    return mo(ea, { key: e, widgetGroups: t, title: n.title, activeButton: n.activeButton, isTodayEnabled: n.isTodayEnabled, isPrevEnabled: n.isPrevEnabled, isNextEnabled: n.isNextEnabled });
                }),
                t
            );
        })(xo),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(
                        _o.Provider,
                        { value: l },
                        n.headerToolbar && mo(ta, r({ ref: this.headerRef, extraClassName: "fc-header-toolbar", model: n.headerToolbar }, i)),
                        mo(na, { liquid: a, height: s, aspectRatio: e, onClick: this.handleNavLinkClick }, this.renderView(t), this.buildAppendContent()),
                        n.footerToolbar && mo(ta, r({ ref: this.footerRef, extraClassName: "fc-footer-toolbar", model: n.footerToolbar }, i))
                    );
                }),
                (t.prototype.componentDidMount = function () {
                    var e = this.props;
    ...
    var pa = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: f, classNames: n.dayHeaderClassNames, content: n.dayHeaderContent, defaultContent: da, didMount: n.dayHeaderDidMount, willUnmount: n.dayHeaderWillUnmount }, function (e, t, n, o) {
                        return mo(
                            "th",
        ...
        fa = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: d, classNames: a.dayHeaderClassNames, content: a.dayHeaderContent, defaultContent: da, didMount: a.dayHeaderDidMount, willUnmount: a.dayHeaderWillUnmount }, function (t, n, o, i) {
                        return mo(
                            "th",
        ...
        ha = (function (e) {
            ...
            return (
                ...
                (t.prototype.computeTiming = function () {
                    ...
                    return (i = Math.min(864e5, i)), { currentState: { nowDate: r, todayRange: va(r) }, nextState: { nowDate: o, todayRange: va(o) }, waitMs: i };
                }),
            ...
            (t.prototype.render = function () {
                ...
                return mo(ha, { unit: "day" }, function (e, t) {
                    return mo(
                        ...
                        i && i("day"),
                        n.map(function (e) {
                            return o ? mo(pa, { key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a }) : mo(fa, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a });
                        })
                    );
                });
            }),
    ...
    function La(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++) for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(mo("col", { style: { width: "shrink" === a.width ? Wa(t) : a.width || "", minWidth: a.minWidth || "" } }));
    ...
    var qa = (function (e) {
        ...
        return (
            ...
            (t.prototype.renderSection = function (e, t) {
                return "outerContent" in e ? mo(So, { key: e.key }, e.outerContent) : mo("tr", { key: e.key, className: za(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, t, e.chunk));
            }),
            (t.prototype.renderChunkTd = function (e, t, n) {
                ...
                return mo(
                    ...
                    mo(
                        ...
                        mo(Pa, { ref: this.scrollerRefs.createRef(d), elRef: this.scrollerElRefs.createRef(d), overflowY: c, overflowX: r.liquid ? "hidden" : "visible", maxHeight: e.maxHeight, liquid: u, liquidIsAbsolute: !0 }, p)
                    )
                );
            }),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context,
                        n = t.options,
                        r = Qa({ date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, showDayNumber: e.showDayNumber, extraProps: e.extraHookProps, viewApi: t.viewApi, dateEnv: t.dateEnv });
    ...
    function Qa(e) {
        ...
        return r(r(r({ date: n.toDate(t), view: e.viewApi }, o), { dayNumberText: e.showDayNumber ? n.format(t, $a) : "" }), e.extraProps);
    }
    var es = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
    ...
    var ns = function (e) {
        return mo(
            Ya,
            { defaultContent: rs, seg: e.seg, timeText: "", disableDragging: !0, disableResizing: !0, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1, isPast: e.isPast, isFuture: e.isFuture, isToday: e.isToday },
            function (e, t, n, r, o) {
    ...
    var os = function (e) {
        return mo(_o.Consumer, null, function (t) {
            var n = t.dateEnv,
                ...
                s = n.format(o, i);
            return mo(Lo, { hookProps: { num: a, text: s, date: o }, classNames: r.weekNumberClassNames, content: r.weekNumberContent, defaultContent: is, didMount: r.weekNumberDidMount, willUnmount: r.weekNumberWillUnmount }, e.children);
        });
    };
    function is(e) {
        return e.text;
        ...
        ss = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(es, { date: o, dateProfile: a, todayRange: i, elRef: this.handleRootEl }, function (e, t, n) {
                        return mo(
                            as,
                            ...
                            mo(Ja, { date: o, dateProfile: a, todayRange: i }, function (e, t) {
            ...
            return (
                ...
                (o.handleRenderRequest = function () {
                    if (o.isRendering) {
                        ...
                        var e = o.currentData;
                        yo(
                            mo(la, { options: e.calendarOptions, theme: e.theme, emitter: e.emitter }, function (t, n, i, a) {
                                return o.setClassNames(t), o.setHeight(n), mo(Wo.Provider, { value: o.customContentRenderId }, mo(ia, r({ isHeightAuto: i, forPrint: a }, e)));
                            }),
                            o.el
                        );
        ...
        ys = (function () {
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    1 === (gs += 1) && window.addEventListener("touchmove", Es, { passive: !1 });
            }
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
                        this.containerEl.removeEventListener("touchstart", this.handleTouchStart, { passive: !0 }),
                        (gs -= 1) || window.removeEventListener("touchmove", Es, { passive: !1 });
                }),
                ...
                (n.handlePointerDown = function (e) {
                    ...
                    (n.handleDragEnd = function (e) {
                        ...
                        if (!n.dragging.pointer.wasTouchScroll) {
                            ...
                            if (i && a && xs(i, a)) {
                                var s = t.context,
                                    l = r(r({}, Ms(i.dateSpan, s)), { dayEl: i.dayEl, jsEvent: e.origEvent, view: s.viewApi || s.calendarApi.view });
                        ...
                        if (e) {
                            ...
                            i === a || (d.editable && d.droppable)
                                ? (s = (function (e, t, n) {
                                  ...
                                  ((l = hr(n, a.getCurrentData().eventUiBases, s, a)), (c.mutatedEvents = l), ba(c, e.dateProfile, a) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = { defs: {}, instances: {} })))
                                : (a = null);
                        }
                        o.displayDrag(a, c),
                            u ? He() : Oe(),
                        ...
                        if ((o.clearDrag(), t.emitter.trigger("eventDragStop", { el: o.subjectEl, event: c, jsEvent: e.origEvent, view: n }), s)) {
                            if (a === t) {
                                ...
                                a.emitter.trigger("eventAdd", w),
                                    ...
                                    a.emitter.trigger("drop", r(r({}, Ms(f.dateSpan, a)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: f.context.viewApi })),
        ...
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleHitUpdate = function (e, t, r) {
                    ...
                    l && ((u = hr(i, o.getCurrentData().eventUiBases, l, o)), (d.mutatedEvents = u), ba(d, e.dateProfile, o) || ((c = !0), (l = null), (u = null), (d.mutatedEvents = null))),
                        u ? o.dispatch({ type: "SET_EVENT_RESIZE", state: d }) : o.dispatch({ type: "UNSET_EVENT_RESIZE" }),
                        c ? He() : Oe(),
                        t || (l && xs(a, e) && (l = null), (n.validMutation = l), (n.mutatedRelevantEvents = u));
                }),
                (n.handleDragEnd = function (e) {
                    var t = n.component.context,
                        o = n.eventRange.def,
    ...
    var Os = (function () {
        ...
        Us = { dateClick: fn, eventDragStart: fn, eventDragStop: fn, eventDrop: fn, eventResizeStart: fn, eventResizeStop: fn, eventResize: fn, drop: fn, eventReceive: fn, eventLeave: fn },
        Ls = (function () {
            function e(e, t) {
                var n = this;
                    ...
                    (this.handleHitUpdate = function (e, t, o) {
                        ...
                        e &&
                            ...
                            n.canDropElOnCalendar(o.subjectEl, a) &&
                                ...
                                (l = !ba(u, e.dateProfile, a)) && ((u.mutatedEvents = { defs: {}, instances: {} }), (s = null)))),
                            n.displayDrag(a, u),
                    ...
                    (this.handleDragEnd = function (e) {
                        ...
                        if ((n.clearDrag(), o && i)) {
                            var a = n.hitDragging.finalHit,
                                s = a.context.viewApi,
                                l = n.dragMeta;
                            if ((o.emitter.trigger("drop", r(r({}, Ms(a.dateSpan, o)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: s })), l.create)) {
                                var u = vn(i);
    ...
    var Ws = (function () {
        ...
        zs = Ho({ componentInteractions: [Ps, Is, Ns, Hs], calendarInteractions: [Os], elementDraggingImpl: _s, optionRefiners: As, listenerRefiners: Us }),
        Bs = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
            ...
            return (
                ...
                (t.prototype.renderSimpleLayout = function (e, t) {
                    ...
                    return (
                        ...
                        mo(qo, { viewSpec: r.viewSpec }, function (e, t) {
                            return mo("div", { ref: e, className: ["fc-daygrid"].concat(t).join(" ") }, mo(qa, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: o }));
                        })
                    );
                }),
                (t.prototype.renderHScrollLayout = function (e, t, n, r) {
                    ...
                    return (
                        ...
                        l && u.push({ type: "footer", key: "footer", isSticky: !0, chunks: [{ key: "main", content: Ba }] }),
    ...
    var Ys = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return mo(Ja, { date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, showDayNumber: e.showDayNumber, extraHookProps: e.extraHookProps, defaultContent: Zs }, function (n, o) {
    ...
    var Xs = nn({ hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "narrow" });
    function Ks(e) {
    ...
    var $s = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(
                        Za,
                        r({}, e, { extraClassNames: ["fc-daygrid-event", "fc-daygrid-block-event", "fc-h-event"], defaultTimeFormat: Xs, defaultDisplayEventEnd: e.defaultDisplayEventEnd, disableResizing: !e.seg.eventRange.def.allDay })
                    );
                }),
                t
            );
        ...
        Js = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(
                        Ya,
                        { seg: e.seg, timeText: o, defaultContent: Qs, isDragging: e.isDragging, isResizing: !1, isDateSelecting: !1, isSelected: e.isSelected, isPast: e.isPast, isFuture: e.isFuture, isToday: e.isToday },
                        function (t, n, o, i) {
                            ...
                            return mo(
                                ...
                                n.map(function (n) {
                                    ...
                                    return mo(
                                        ...
                                        Ks(n)
                                            ? mo(Js, r({ seg: n, isDragging: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1 }, nr(n, e.todayRange)))
                                            : mo($s, r({ seg: n, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1 }, nr(n, e.todayRange)))
                                    );
                                })
                            );
                        },
        ...
        rl = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(es, { date: a, dateProfile: s, todayRange: t.todayRange, showDayNumber: t.showDayNumber, extraHookProps: t.extraHookProps, elRef: this.handleRootEl }, function (e, n, i, u) {
                        return mo(
                            "td",
                            ...
                            mo(
                                ...
                                t.showWeekNumber &&
                                    mo(os, { date: a, defaultFormat: nl }, function (e, t, n, o) {
                                        return mo("a", r({ ref: e, className: ["fc-daygrid-week-number"].concat(t).join(" ") }, l), o);
                                    }),
                                !u && mo(Ys, { date: a, dateProfile: s, showDayNumber: t.showDayNumber, forceDayTop: t.forceDayTop, todayRange: t.todayRange, extraHookProps: t.extraHookProps }),
                                mo(
                                    "div",
    ...
    function ol(e, t, n, r, o, i, a) {
        ...
        for (
                ...
                f = (function (e, t, n) {
                    for (
                        ...
                        for (var l = r[s], u = [], c = 0, d = 0, p = 0, f = l; p < f.length; p++) {
                            var h = t[(y = f[p]).index];
                            u.push({ seg: il(h, s, s + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: 0, marginTop: y.levelCoord - c }), (c = y.levelCoord + y.thickness);
                        }
                        var v = [];
                        (c = 0), (d = 0);
                        for (var g = 0, m = l; g < m.length; g++) {
                            ...
                            (d += y.levelCoord - c),
                                ...
                                E
                                    ? ((d += y.thickness), S && v.push({ seg: il(h, y.span.start, y.span.end, n), isVisible: !0, isAbsolute: !0, absoluteTop: y.levelCoord, marginTop: 0 }))
                                    : S && (v.push({ seg: il(h, y.span.start, y.span.end, n), isVisible: !0, isAbsolute: !1, absoluteTop: 0, marginTop: d }), (d = 0));
                        }
            ...
            for (var D = R.firstCol; D <= R.lastCol; D += 1) h[D].push({ seg: il(R, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
        ...
        for (var b = 0, C = p; b < C.length; b++) {
            var w = C[b],
                R = e[w.index],
                _ = w.span;
            v[_.start].push({ seg: il(R, _.start, _.end, a), isVisible: !1, isAbsolute: !0, absoluteTop: 0, marginTop: 0 });
            for (D = _.start; D < _.end; D += 1) (m[D] += 1), h[D].push({ seg: il(R, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
                            ...
                            D && (l.isRtl ? ((C = 0), (b = c.lefts[m.lastCol] - c.lefts[m.firstCol])) : ((b = 0), (C = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                                f.push(
                                    mo(
                                        ...
                                        Ks(m)
                                            ? mo(Js, r({ seg: m, isDragging: i, isSelected: y === u, defaultDisplayEventEnd: d }, nr(m, n)))
                                            : mo($s, r({ seg: m, isDragging: i, isResizing: a, isDateSelecting: s, isSelected: y === u, defaultDisplayEventEnd: d }, nr(m, n)))
                                    )
                                );
                        }
                    return f;
                ...
                (t.prototype.renderFillSegs = function (e, t) {
                    ...
                    if (a)
                        for (var l = 0, u = e; l < u.length; l++) {
                            ...
                            s.push(mo("div", { key: or(c.eventRange), className: "fc-daygrid-bg-harness", style: d }, "bg-event" === t ? mo(ns, r({ seg: c }, nr(c, i))) : ts(t)));
                        }
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        a = n.dayHeaders && mo(ga, { ref: this.headerRef, dateProfile: o.dateProfile, dates: i.headerDates, datesRepDistinctDays: 1 === i.rowCnt }),
                        s = function (t) {
                            return mo(dl, {
                                ref: e.tableRef,
    ...
    var hl = Ho({
        ...
        gl = nn({ hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "short" });
    function ml(e) {
        ...
        return mo(_o.Consumer, null, function (n) {
            ...
            return mo(Lo, { hookProps: s, classNames: o.slotLabelClassNames, content: o.slotLabelContent, defaultContent: yl, didMount: o.slotLabelDidMount, willUnmount: o.slotLabelWillUnmount }, function (n, r, o, i) {
                return mo(
                    "td",
                ...
                return (
                    ...
                    (t.renderHeadAxis = function (e, n) {
                        ...
                        return o.weekNumbers && "day" === e
                            ? mo(os, { date: i.start, defaultFormat: Sl }, function (e, t, o, i) {
                                  return mo(
                                      "th",
                    ...
                    (t.renderTableRowAxis = function (e) {
                        ...
                        return mo(Lo, { hookProps: i, classNames: r.allDayClassNames, content: r.allDayContent, defaultContent: bl, didMount: r.allDayDidMount, willUnmount: r.allDayWillUnmount }, function (t, n, r, o) {
                            return mo(
                                "td",
                ...
                (t.prototype.renderSimpleLayout = function (e, t, n) {
                    ...
                    return (
                        ...
                        mo(qo, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
                            return mo("div", { className: ["fc-timegrid"].concat(t).join(" "), ref: e }, mo(qa, { liquid: !o.isHeightAuto && !o.forPrint, collapsibleWidth: o.forPrint, cols: [{ width: "shrink" }], sections: i }));
                        })
                    );
                }),
                            ...
                            chunks: [
                                {
                                    ...
                                    content: function (e) {
                                        return mo(
                                            ...
                                            mo("table", { style: { height: e.expandRows ? e.clientHeight : "" } }, e.tableColGroupNode, mo("tbody", null, mo(El, { slatMetas: i }))),
                                            mo(
                                                "div",
                                                ...
                                                mo(ha, { unit: h ? "minute" : "day" }, function (e) {
                                                    ...
                                                    return "number" == typeof t
                                                        ? mo(Ka, { isAxis: !0, date: e }, function (e, n, r, o) {
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(
                        ...
                        mo(
                            ...
                            e.tableColGroupNode,
                            mo(wl, { slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas })
                        )
                    );
                }),
                (t.prototype.componentDidMount = function () {
    ...
    function Ml(e, t, n) {
        ...
        var i,
            ...
            u = (function (e) {
                        ...
                        function (o, i) {
                            var a = Pl(
                                    (function (e, t, n) {
                                        ...
                                        for (; l < s; l += 1) {
                                            for (var u = o[l], c = void 0, d = Gi(u, i.span.start, Wi), p = d[0] + d[1], f = p; (c = u[f]) && c.span.start < i.span.end; ) f += 1;
                ...
                return Pl(t.length ? { level: 0, lateralStart: 0, lateralEnd: t[0].length } : null, n)[0];
            })(o);
        return (
            (i = u),
            (a = 1),
    ...
    var Al = nn({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
        Ul = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return this.props.isShort && e.push("fc-timegrid-event-short"), mo(Za, r({}, this.props, { defaultTimeFormat: Al, extraClassNames: e }));
                }),
                t
            );
        })(xo),
        Ll = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props;
                    return mo(Ja, { date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, extraHookProps: e.extraHookProps }, function (e, t) {
        ...
        Wl = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(es, { elRef: t.elRef, date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps }, function (n, l, u) {
                        return mo(
                            "td",
                            ...
                            mo(
                                ...
                                mo("div", { className: "fc-timegrid-col-events" }, e.renderFgSegs(s, a, !1, !1, !1)),
                                ...
                                mo(Ll, { date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps })
                            )
                        );
                    });
                }),
                    ...
                    return mo(
                        ...
                        S.map(function (e) {
                            ...
                            return mo(
                                ...
                                mo(Ul, r({ seg: s, isDragging: n, isResizing: o, isDateSelecting: i, isSelected: c === v, isShort: E }, nr(s, g, m)))
                            );
                        })
                    );
                }),
                (t.prototype.renderHiddenGroups = function (e, t) {
                    ...
                    return mo(
                        ...
                        e.map(function (e) {
                            ...
                            return mo(kl, { key: At(ds(p)), hiddenSegs: p, top: d.top, bottom: d.bottom, extraDateSpan: r, dateProfile: o, todayRange: i, nowDate: a, eventSelection: s, eventDrag: l, eventResize: u });
                        })
                    );
                }),
                (t.prototype.renderFillSegs = function (e, t) {
                    var n = this.props,
                        ...
                        i = Ol(e, n.date, n.slatCoords, o.options.eventMinHeight).map(function (o, i) {
                            var a = e[i];
                            return mo("div", { key: or(a.eventRange), className: "fc-timegrid-bg-harness", style: Fl(o) }, "bg-event" === t ? mo(ns, r({ seg: a }, nr(a, n.todayRange, n.nowDate))) : ts(t));
                        });
                    return mo(So, null, i);
                }),
                (t.prototype.renderNowIndicator = function (e) {
                    ...
                    return n
                        ? e.map(function (e, t) {
                              return mo(Ka, { isAxis: !1, date: r, key: t }, function (t, o, i, a) {
    ...
    function Vl(e, t) {
        ...
        return mo(
            ...
            e.map(function (e) {
                ...
                return mo("div", { key: t, style: { visibility: l[t] ? "hidden" : "" } }, mo(Ul, r({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: t === i, isShort: !1 }, nr(e, n, o))));
            })
        );
    }
    function Fl(e) {
                                    ...
                                    mo(
                                        ...
                                        mo(
                                            ...
                                            mo(
                                                ...
                                                { className: "fc-timegrid-now-indicator-container" },
                                                "number" == typeof n &&
                                                    mo(Ka, { isAxis: !0, date: t.nowDate }, function (e, t, r, o) {
    ...
    var Zl = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
        ...
        for (
            var i = new Date(0),
                ...
                l =
                    ...
                    (function (e) {
                        var t, n, r;
                        for (t = Zl.length - 1; t >= 0; t -= 1) if (null !== (r = Ht((n = kt(Zl[t])), e)) && r > 1) return n;
                        return e;
                    })(r),
                u = [];
            Nt(a) < Nt(t);
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this,
                    ...
                    p = !d,
                    f = d,
                    h = n.dayHeaders && mo(ga, { dates: l.headerDates, dateProfile: s, datesRepDistinctDays: !0, renderIntro: p ? this.renderHeadAxis : null }),
                    v =
                        !1 !== n.allDaySlot &&
                        function (t) {
                            return mo(
    ...
    var Jl = Ho({
            ...
            views: {
                timeGrid: { component: Kl, usesMinMaxTime: !0, allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0 },
        ...
        Ql = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return mo(Lo, { hookProps: f, classNames: s.dayHeaderClassNames, content: s.dayHeaderContent, defaultContent: eu, didMount: s.dayHeaderDidMount, willUnmount: s.dayHeaderWillUnmount }, function (e, n, r, o) {
                                ...
                                (function (e, t, n) {
                                    ...
                                    if (!1 !== r.displayEventTime) {
                                        ...
                                        if (
                                            ...
                                            return mo(Lo, { hookProps: l, classNames: r.allDayClassNames, content: r.allDayContent, defaultContent: ou, didMount: r.allDayDidMount, willUnmount: r.allDayWillUnmount }, function (e, t, n, r) {
    ...
    var iu = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return mo(qo, { viewSpec: n.viewSpec, elRef: this.setRootEl }, function (n, o) {
                    return mo(
                        ...
                        mo(Pa, { liquid: !t.isHeightAuto, overflowX: t.isHeightAuto ? "visible" : "hidden", overflowY: t.isHeightAuto ? "visible" : "auto" }, s.length > 0 ? e.renderSegList(s, i) : e.renderEmptyMessage())
                    );
                });
            }),
            (t.prototype.renderEmptyMessage = function () {
                ...
                return mo(Lo, { hookProps: r, classNames: t.noEventsClassNames, content: t.noEventsContent, defaultContent: au, didMount: t.noEventsDidMount, willUnmount: t.noEventsWillUnmount }, function (e, t, n, r) {
                    ...
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        ...
                        if (u) {
                            ...
                            for (var d = 0, p = (u = Kn(u, i.eventOrder)); d < p.length; d++) {
                                var f = p[d];
                                s.push(mo(nu, r({ key: c + ":" + f.eventRange.instance.instanceId, seg: f, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1 }, nr(f, n, e))));
                            }
                        }
                    }
    ...
    var uu = Ho({
            optionRefiners: { listDayFormat: lu, listDaySideFormat: lu, noEventsClassNames: fn, noEventsContent: fn, noEventsDidMount: fn, noEventsWillUnmount: fn },
            views: {
                list: { component: iu, buttonTextKey: "list", listDayFormat: { month: "long", day: "numeric", year: "numeric" } },
    ...
    (cu.prototype.classes = {
        ...
        (cu.prototype.iconClasses = { close: "fa-times", prev: "fa-chevron-left", next: "fa-chevron-right", prevYear: "fa-angle-double-left", nextYear: "fa-angle-double-right" }),
        (cu.prototype.rtlIconClasses = { prev: "fa-chevron-right", next: "fa-chevron-left", prevYear: "fa-angle-double-right", nextYear: "fa-angle-double-left" }),
