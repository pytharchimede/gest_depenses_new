!(function () {
    ...
    function n(e) {
        document.getElementById("header-lang-img") &&
            ...
            (e = new XMLHttpRequest()).open("GET", "/assets/lang/" + t + ".json"),
        ...
        setTimeout(function () {
            ...
            a &&
                ...
                300 < (e = a ? a.offsetTop : 0) &&
                    ((e -= 100),
                    (t = document.getElementsByClassName("vertical-menu") ? document.getElementsByClassName("vertical-menu")[0] : "") &&
            ...
            window.sessionStorage &&
                ((e = sessionStorage.getItem("is_visited"))
                    ? null !== (t = document.querySelector("#" + e)) &&
                      ((t.checked = !0),
                      (t = e),
                      1 == document.getElementById("layout-direction-ltr").checked && "layout-direction-ltr" === t
    ...
    if (
                    ...
                    e.href == t &&
                        ...
                        (t = e.parentElement) &&
                            ...
                            (e = t.parentElement) &&
                                ...
                                e.classList.contains("mm-collapsing") && console.log("has mm-collapsing"),
                                (t = e.parentElement) &&
                                    "side-menu" !== t.id &&
                                    (t.classList.add("mm-active"), (e = t.parentElement) && "side-menu" !== e.id && (e.classList.add("mm-show"), (t = e.parentElement) && "side-menu" !== t.id && t.classList.add("mm-active"))))));
                });
        }, 0),
            ...
            u.forEach(function (e) {
                ...
                e.href == t &&
                    ...
                    (t = e.parentElement) &&
                        ...
                        (t = e.parentElement) && (t.classList.add("active"), (e = t.parentElement) && (e.classList.add("active"), (t = e.parentElement) && (t.classList.add("active"), (e = t.parentElement) && e.classList.add("active"))))));
            }),
        ...
        for (var h = document.getElementById("topnav-menu-content").getElementsByTagName("a"), p = 0, E = h.length; p < E; p++)
    ...
    [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function (e) {
        ...
        (c = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout")
            ? (r("layout-horizontal"), (document.getElementById("sidebar-setting").style.display = "none"))
            : r("layout-vertical"),
        c.hasAttribute("data-layout-mode") && "dark" == c.getAttribute("data-layout-mode") ? r("layout-mode-dark") : r("layout-mode-light"),
        c.hasAttribute("data-layout-size") && "boxed" == c.getAttribute("data-layout-size") ? r("layout-width-boxed") : r("layout-width-fluid"),
        c.hasAttribute("data-layout-scrollable") && "true" == c.getAttribute("data-layout-scrollable") ? r("layout-position-scrollable") : r("layout-position-fixed"),
        c.hasAttribute("data-topbar") && "dark" == c.getAttribute("data-topbar") ? r("topbar-color-dark") : r("topbar-color-light"),
        c.hasAttribute("data-sidebar-size") && "sm" == c.getAttribute("data-sidebar-size")
            ? r("sidebar-size-small")
            : c.hasAttribute("data-sidebar-size") && "md" == c.getAttribute("data-sidebar-size")
            ? r("sidebar-size-compact")
            : r("sidebar-size-default"),
        c.hasAttribute("data-sidebar") && "brand" == c.getAttribute("data-sidebar")
            ? r("sidebar-color-brand")
            : c.hasAttribute("data-sidebar") && "dark" == c.getAttribute("data-sidebar")
            ? r("sidebar-color-dark")
            : r("sidebar-color-light"),
        document.getElementsByTagName("html")[0].hasAttribute("dir") && "rtl" == document.getElementsByTagName("html")[0].getAttribute("dir") ? r("layout-direction-rtl") : r("layout-direction-ltr"),
                ...
                e &&
                    ...
                    ("light" == e.target.value
                        ? (document.body.setAttribute("data-layout-mode", "light"),
                          ...
                          (c.hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout")) || document.body.setAttribute("data-sidebar", "light"),
                          r("topbar-color-light"),
                          r("sidebar-color-light"))
                        : (document.body.setAttribute("data-layout-mode", "dark"),
                          document.body.setAttribute("data-topbar", "dark"),
                          document.body.setAttribute("data-sidebar", "dark"),
                          (c.hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout")) || document.body.setAttribute("data-sidebar", "dark"),
                          r("topbar-color-dark"),
                          r("sidebar-color-dark")));
            });
        }),
