document.addEventListener("DOMContentLoaded", function () {
    ...
    for (i = 0; i < e.length; ++i) {
        var a = e[i];
        new Choices(a, { placeholderValue: "Faites votre choix", searchPlaceholderValue: "Faites votre choix" });
    }
    new Choices("#choices-single-no-search", {
        ...
        new Choices(document.getElementById("choices-text-remove-button"), { delimiter: ",", editItems: !0, maxItemCount: 5, removeItemButton: !0 }),
        new Choices("#choices-text-unique-values", { paste: !1, duplicateItemsAllowed: !1, editItems: !0 }),
...
flatpickr("#datepicker-basic"),
    flatpickr("#datepicker-datetime", { enableTime: !0, dateFormat: "m-d-Y H:i" }),
    flatpickr("#datepicker-humanfd", { altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d" }),
