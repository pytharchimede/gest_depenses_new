            ...
            <div class="page-content">
                ...
                <div class="col-lg-2">
                            ...
                            <div class="col-lg-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Budget (<?php echo number_format($valeur_initiale_budget,0,',',' '); ?> FCFA)</h4>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-lg-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Budget / Service</h4>
                                    </div>
                                    <div class="card-body">
...
<div class="col-lg-12 col-xs-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Prévues | Exécutés</h4>
        </div>
        <div class="card-body">
...
$bud_serv_1->execute(); 
    ...
    <script>
        ...
        Swal.fire({ title: "<?php $_SESSION['nom_utilisateur_hop']; ?>, ", text: "Bienvenu sur G-FORM !", icon: "success", showCancelButton: !0, confirmButtonColor: "#038edc", cancelButtonColor: "#f34e4e" });
    }),
    </script>
