...
?>
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php include('titre_ent_1.php'); ?> | Demandes planifiées</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="accueil.php" class="logo logo-light">
                                <span class="log<span data-key=" t-dashboards">réfusées</span>
                                </span>
                                <span class="logo-lg">
                                    <?php include('titre_ent_ac.php'); ?>
                                </span>
                        ...
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="sauvegarder.php" id="topnav-dashboard" style="background-color:#fabd02; color:#22254b;">
                                            <i class="icon nav-icon uil uil-money-withdrawal"></i>
                ...
                <div class="page-content">
                                ...
                                <div class="card-body" style="position: relative;">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-xs-12" style="margin-top:10px;">
                                            ...
                                            <select disabled class="form-control" data-trigger id="recher_etat" name="recher_etat">
                                                <option value="0">Etat de la fiche</option>
                                                <option value="1" selected>Acceptée</option>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-start justify-content-md-end mt-2 mt-md-0 gap-2 mb-3">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" target="_blank" title="exporter en pdf" href="exportation/pdf/pdf_liste_sauvegarder.php"><i class="fa fa-file-pdf"></i> Fichier PDF</a></li>
                                                            </ul>
                                                            <!-- end ul -->
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="affiche_sauvegarder row"></div>
                                                <!--/contenu page-->
                                                </tbody>
                                                </table>
                                            </div>
                    ...
                    <div class="right-bar">
                        <div data-simplebar class="h-100">
                            ...
                            <script type="text/javascript" src="js/function_sauvegarder.js"></script>
    </body>
