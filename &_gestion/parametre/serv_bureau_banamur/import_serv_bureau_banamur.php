...
$red=$con->prepare("SELECT * FROM serv_bureau_banamur WHERE lib_serv_bureau_banamur =:A "); 
...
else
{
  ...
  $req=$con->prepare("INSERT INTO serv_bureau_banamur(lib_serv_bureau_banamur) VALUES (:A)");
...
$date=gmdate('Y-m-d H:i:s');
  ...
  $lib_trace="Ajout de l\'serv_bureau_banamur <b>".$lib_aff."</b>";
