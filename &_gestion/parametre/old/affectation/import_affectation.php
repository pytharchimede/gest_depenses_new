...
$red=$con->prepare("SELECT * FROM affectation WHERE lib_affectation =:A "); 
...
else
{
  ...
  $req=$con->prepare("INSERT INTO affectation(lib_affectation) VALUES (:A)");
...
$date=gmdate('Y-m-d H:i:s');
  ...
  $lib_trace="Ajout de l\'affectation <b>".$lib_aff."</b>";
