...
$red=$con->prepare("SELECT * FROM serv_bureau_fidest WHERE lib_serv_bureau_fidest =:A "); 
...
else
{
  ...
  $req=$con->prepare("INSERT INTO serv_bureau_fidest(lib_serv_bureau_fidest) VALUES (:A)");
...
$date=gmdate('Y-m-d H:i:s');
  ...
  $lib_trace="Ajout de l\'serv_bureau_fidest <b>".$lib_aff."</b>";
