...
<html lang="en">
    ...
    <header id="page-topbar">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown"
                            ...
                            <span class="ms-2 d-none d-sm-block user-item-desc">
                                <span class="user-name"><?php echo $_SESSION['nom_utilisateur_hop']; ?></span>
     ...
     <img src="../img/import_csv.png" width="300" height="300" style="display:block; margin-left:auto; margin-right:auto;"/>
	
    <form action="serv_bureau_banamur/import_serv_bureau_banamur.php" method="post" enctype="multipart/form-data">
	     
        <input style="display:block; margin-left:auto; margin-right:auto;" type="file" name="file1" id="file1" />

  
   <button style="display:block; margin:4px; margin-left:auto; margin-right:auto; background-color:#16424d; border:#16424d;" type="submit" class="btn btn-success button_importer" id="button_importer" ><i class="fa fa-download"></i> Importer</button>
    </form>
               </div>
               <!--End Middle Col-->
