...
<body data-layout="horizontal"> 
    ...
    <div class="collapse navbar-collapse" id="topnav-menu-content">
        ...
        <div class="main-content">
            <div class="page-content">
               ...
               <li class="tit_para">serv_log</li>
               </ul>
               
   <button id="ajout_serv_log" data-toggle="modal" data-target="#myModal_serv_log" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Ajouter serv_log</button>
   <button id="import_serv_log" style="margin:10px; " class="btn btn-warning"><i class="fa fa-download"></i> Importer serv_log</button>
                       ...
                       <div class="page-content-wrap"  style="">
                           ...
                           <div class="row voir aff_serv_log">
               ...
               <li class="tit_para">serv_bureau_fidest</li>
               </ul>
               
   <button id="ajout_serv_bureau_fidest" data-toggle="modal" data-target="#myModal_serv_bureau_fidest" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Ajouter serv_bureau_fidest</button>
   <button id="import_serv_bureau_fidest" style="margin:10px; " class="btn btn-warning"><i class="fa fa-download"></i> Importer serv_bureau_fidest</button>
                       ...
                       <div class="page-content-wrap"  style="">
                           ...
                           <div class="chargement"></div>               
                           <div class="row voir aff_serv_bureau_fidest">
                       ...
                       <!--/fin serv_bureau_fidest-->
                       
                            <!--Debut serv_bureau_banamur-->
						<div class="col-md-6 col-xs-12">
               ...
               <li class="tit_para">serv_bureau_banamur</li>
               </ul>
               
   <button id="ajout_serv_bureau_banamur" data-toggle="modal" data-target="#myModal_serv_bureau_banamur" style="margin:10px; " class="btn btn-purple"><i class="fa fa-plus"></i> Ajouter serv_bureau_banamur</button>
   <button id="import_serv_bureau_banamur" style="margin:10px; " class="btn btn-warning"><i class="fa fa-download"></i> Importer serv_bureau_banamur</button>
                       ...
                       <div class="page-content-wrap"  style="">
                           ...
                           <div class="chargement"></div>               
                           <div class="row voir aff_serv_bureau_banamur">
   ...
   <button id="import_designation" style="margin:10px; " class="btn btn-warning"><i class="fa fa-upload"></i> Importer designation</button>
   <button id="download_designation" style="margin:10px; " class="btn btn-success"><i class="fa fa-file-excel"></i> Télécharger designation</button>
   <a href="designation/fichier_import.csv" style="margin:10px; " class="btn btn-success"><i class="fa fa-download"></i> Fichier exemple</a>
            ...
            <!-- Modal serv_log -->
<!-- Modal -->
<div class="modal fade" id="myModal_serv_log" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Ajouter un serv_log </h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_serv_log" id="form_serv_log" class="form-horizontal" action="#">
		
		<div class="row">
        <div class="col-md-12 col-xs-12">
				 <label>Libellé serv_log <span class="semi_aste">*</span></label>
				 <input type="text" class="form-control" required id="lib_serv_log" name="lib_serv_log"  />
        </div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_serv_log_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification serv_log</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_serv_log_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_serv_log_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression serv_log</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_serv_log_sup"></div>
		</div>
        ...
        <button type="submit" id="submit_serv_log_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
...
<!-- fin modal serv_log-->
<!-- Modal serv_bureau_fidest -->
<!-- Modal -->
<div class="modal fade" id="myModal_serv_bureau_fidest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Ajouter un serv_bureau_fidest </h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_serv_bureau_fidest" id="form_serv_bureau_fidest" class="form-horizontal" action="#">
		
		<div class="row">
        <div class="col-md-12 col-xs-12">
				 <label>Libellé serv_bureau_fidest <span class="semi_aste">*</span></label>
				 <input type="text" class="form-control" required id="lib_serv_bureau_fidest" name="lib_serv_bureau_fidest"  />
        </div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_serv_bureau_fidest_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification serv_bureau_fidest</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_serv_bureau_fidest_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_serv_bureau_fidest_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression serv_bureau_fidest</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_serv_bureau_fidest_sup"></div>
		</div>

		<div class="modal-footer ajout-footer">
        <button type="button" class="btn button_annuler" data-dismiss="modal"><i class="fa fa-times"></i> Non</button>
        <button type="submit" id="submit_serv_bureau_fidest_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
	  
    </div>
  </div>
</div>	
<!-- fin modal serv_bureau_fidest-->
<!-- Modal serv_bureau_banamur -->
<!-- Modal -->
<div class="modal fade" id="myModal_serv_bureau_banamur" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header ajout_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Ajouter un serv_bureau_banamur </h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
				
				
	  <form name="form_serv_bureau_banamur" id="form_serv_bureau_banamur" class="form-horizontal" action="#">
		
		<div class="row">
        <div class="col-md-12 col-xs-12">
				 <label>Libellé serv_bureau_banamur <span class="semi_aste">*</span></label>
				 <input type="text" class="form-control" required id="lib_serv_bureau_banamur" name="lib_serv_bureau_banamur"  />
        </div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_serv_bureau_banamur_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modif_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Modification serv_bureau_banamur</h4>
      </div>
      <div class="modal-body">
	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_serv_bureau_banamur_mod"></div>
		</div>
...
<div class="modal fade mod_pop" id="myModal_serv_bureau_banamur_sup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header sup_header">
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Suppression serv_bureau_banamur</h4>
      </div>
      <div class="modal-body">

	    <div style="background-color:red; color:#fff; text-align:center;" class="msg_erreur"></div>
		<div id="affiche_serv_bureau_banamur_sup"></div>
		</div>

		<div class="modal-footer ajout-footer">
        <button type="button" class="btn button_annuler" data-dismiss="modal"><i class="fa fa-times"></i> Non</button>
        <button type="submit" id="submit_serv_bureau_banamur_sup" class="btn button_supprimer"><i class="fa fa-bitbucket"></i> Oui</button>&nbsp;&nbsp;&nbsp;
      </div>
	  
    </div>
  </div>
</div>	
<!-- fin modal serv_bureau_banamur-->
