                        ...
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link arrow-none" href="accepte.php" id="topnav-dashboard" style="background-color:#fabd02; color:#22254b;">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <h5 class="card-title">Liste des demandes
                                                            <span class="text-muted fw-normal ms-2">
                                                                (
                                                                <?php
                                                                $nf = $con->prepare('SELECT * FROM fiche WHERE etat_fiche=1 AND decaisse=0 AND sauvegarder=0 ORDER BY id_fiche ASC ');
                                                                $nf->execute();
                                                                $qnf = $nf->rowcount();
                                                                echo $qnf;
                                                                ?>
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-start justify-content-md-end mt-2 mt-md-0 gap-2 mb-3">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" target="_blank" title="exporter en pdf" href="exportation/pdf/pdf_liste_accepte.php"><i class="fa fa-file-pdf"></i> Liste des demandes acceptées</a></li>
                                                                <li><a class="dropdown-item" target="_blank" title="exporter en pdf" href="exportation/pdf/pdf_liste_money.php"><i class="fa fa-file-pdf"></i> Liste des dépôts à effectuer</a></li>
                                                            </ul>
                                                            <!-- end ul -->
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                $rep = $con->prepare('SELECT * FROM fiche WHERE etat_fiche=1 AND decaisse=0 AND sauvegarder=0 ORDER BY id_fiche ASC ');
                                                $rep->execute();
                                                ...
                                                while ($repo = $rep->fetch()) {
                                                    ...
                                                    if ($repo['date_decaissement'] == "0000-00-00") {
                                                        $date_decaissement = "<b style='color:red;'>Date de décaissement : Indéfinie</b>";
                                                    } else {
                                                        $date_decaissement = "<b style='color:green;'>Date de décaissement : " . date("d/m/Y", strtotime($repo['date_decaissement'])) . "</b>";
                                                    }
                                    ...
                                    <div class="card border shadow-none">
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    ...
                                                    <i> Fait le ' . date("d/m/Y H:i:s", strtotime($repo['date_creat_fiche'])) . ' </i>
                                                     <br><br>
                                                    <i style="background-color:grey__; color:black; font-weight:bold; padding:5px; border-radius:50px; margin:5px;">  ' . $date_decaissement . ' </i>
                                                    </p>
                                                </div>
                                                <div class="flex-shrink-0 dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a target="_blank" href="exportation/pdf/pdf_fiche.php?num_fiche=' . $repo['num_fiche'] . '" class="dropdown-item"> <i class="fa fa-file-pdf"></i> Voir la fiche</a>
                                                           <a target="_blank" href="planification_decaissement.php?num_fiche=' . $repo['num_fiche'] . '" class="dropdown-item"> <i class="fa fa-calendar"></i> Date de décaissement</a>
                                                    </div>
                                                </div><!-- end dropdown -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-group btn-icon" role="group">
                                                ...
                                                /*
        $rep=$con->prepare('SELECT * FROM fiche WHERE etat_fiche=1 AND decaisse=0 ORDER BY id_fiche ASC ');
        $rep->execute();
