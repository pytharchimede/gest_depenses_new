...
?>
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php include('titre_ent_1.php'); ?> | Planification décaissement</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            while ($repo = $rep->fetch()) {
                                ...
                                echo '
            <form name="form_planif_decaisse" id="form_planif_decaisse" class="form-horizontal" action="src/ajout_date_decaisse.php">
                ...
                <div class="col-md-1 col-xs-12">
                        ...
                        <input type="text" class="form-control" readonly required id="montant_fiche" name="montant_fiche" value="' . $repo['montant_fiche'] . '" />
                </div>
                ...
                <div class="col-md-3 col-xs-12">
                  ...
                  <div class="col-md-4 col-xs-12">
                        <label>Date de décaissement <span class="semi_aste">*</span></label>
                        <input type="date" class="form-control" required id="date_decaissement" name="date_decaissement"  />
                </div>
