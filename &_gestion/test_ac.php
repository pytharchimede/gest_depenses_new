...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Horizontal Layout | Dashonic - Admin & Dashboard Template</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-none d-lg-block ms-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-xl p-2">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="dropdown-item" href="javascript:void(0);">Alerts</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Buttons</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Cards</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Dropdowns</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Lightbox</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Modals</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Range Slider</a>
                                    </div>
                                    <div class="col-md-6">
                                        <a class="dropdown-item" href="javascript:void(0);">Progress Bars</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Sweet-Alert</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Tabs & Accordions</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Typography</a>
                                        <a class="dropdown-item" href="javascript:void(0);">General</a>
                            ...
                            <div class="dropdown-menu p-2 dropdown-megamenu">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0);">Laptops &amp; Tablets</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Desktop Computers</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Networking Products (NAS)</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Monitors</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Bags, Cases &amp; Sleeves</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Batteries</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Charges &amp; Adapters</a>
                                    </div>
                                    <div class="col">
                                        <h5 class="font-size-14 ms-4 mt-2">Smartphones & Tablets</h5>
                                        <a class="dropdown-item" href="javascript:void(0);">Apple iPhone</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Android Smartphones</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Phablets</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Apple iPad</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Android Tablets</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Tablets with Keyboard</a>
                                    </div>
                                    <div class="col">
                                        <h5 class="font-size-14 ms-4 mt-2">Television & Video</h5>
                                        <a class="dropdown-item" href="javascript:void(0);">TV Sets</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Home Theater Systems</a>
                                        <a class="dropdown-item" href="javascript:void(0);">DVD Players & Recorders</a>
                                        <a class="dropdown-item" href="javascript:void(0);">DVD-VCR Combos</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Projectors</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Projection Screens</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Satelite Television</a>
                                    </div>
                                    <div class="col">
                                        <h5 class="font-size-14 ms-4 mt-2">Cameras, Photo & Video</h5>
                                        <a class="dropdown-item" href="javascript:void(0);">Point & Shoot Digital Cameras</a>
                                        <a class="dropdown-item" href="javascript:void(0);">DSLR Cameras</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Mirrorless Cameras</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Body Mounted Cameras</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Camera Lenses</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Video Studio</a>
                                    </div>
                                    <div class="col">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                            <a href="index.html" class="dropdown-item" data-key="t-sales">Sales</a>
                                            <a href="dashboards-analytics.html" class="dropdown-item" data-key="t-analytics">Analytics</a>
                                        </div>
                                    </li>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                                    ...
                                                    <a href="user-settings.html" class="dropdown-item" data-key="t-user-settings">User Settings</a>
                                                </div>
                                            </div>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                                            <a href="widgets.html" class="dropdown-item" data-key="t-widgets">Widgets</a>
                                            <div class="dropdown">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        >
                                            ...
                                            <span data-key="t-extra-pages">Extra pages</span> <div class="arrow-down"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-more">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-timeline">
                                                    ...
                                                    <a href="timeline-horizontal.html" class="dropdown-item" data-key="t-horizontal-view">Horizontal View</a>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="topnav-auth-cover">
                                                            ...
                                                            <a href="auth-signin-cover.html" class="dropdown-item" data-key="t-reset-password">Reset Password</a>
