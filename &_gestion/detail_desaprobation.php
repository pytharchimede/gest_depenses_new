...
$_SESSION['num_fiche_desapprouve']=$_GET['num_fiche_desapprouve'];
?>
<!doctype html>
...
<!--
   ...
   &nbsp;
        ...
        <?php
        $num_fiche=$_GET['num_fiche_desapprouve'];
                    ...
                    <div class="container row">
                        <div class="col-md-12">
                            <p style="text-align:center;">
                                ...
                                <form action="src/desapprouver_fiche.php" method="post">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Veuillez saisir vos commentaires ici" id="detail_desapprouve" name="detail_desapprouve" style="height: 100px"></textarea>
                                            <label for="detail_desapprouve">Vos commentaires</label>
                                        </div>
