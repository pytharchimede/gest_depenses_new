...
?>
    ...
    <head>
        ...
        <title><?php include('titre_ent_1.php'); ?> | Point chantier</title>
...
-->
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link arrow-none" href="point_chantier.php" id="topnav-dashboard" style="background-color:#fabd02; color:#22254b;">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="card-body" style="position: relative;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-xs-12" style="margin-top:10px;">
                                            ...
                                            <label class="col-lg-4 control-label"><b>Veuillez sélectionner un Chantier pour une visibilité 360</b><span class="rouge">*</span></label>
                            ...
                            <div class="affiche_point_chantier">
        ...
        <div class="right-bar">
            ...
            <div data-simplebar class="h-100">
                ...
                <script type="text/javascript" src="js/function_point_chantier.js"></script>
